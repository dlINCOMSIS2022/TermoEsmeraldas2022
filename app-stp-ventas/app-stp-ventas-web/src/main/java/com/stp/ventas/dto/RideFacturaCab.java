...
public class RideFacturaCab {
	...
	private List<RideFacturaDet> l_det = new ArrayList<>();
	...
	public List<RideFacturaDet> getL_det() {
		return l_det;
	}
	
	public void setL_det(List<RideFacturaDet> l_det) {
		this.l_det = l_det;
	}
	...
	public void addDetalle(RideFacturaDet det){
		l_det.add(det);
	}
	
	public void removeDetalle(RideFacturaDet det){
		l_det.remove(det);
	}
