...
@Entity
@Table(name = "terubicacion_operadorbm")
public class TerUbicacionOperadorBM extends EntidadBaseAuditable<Long> implements Serializable {
...
public void setDescripcion_tablero(String nombrepuesto) {
