...
public class GestorClaveAcceso {
	...
	/**
	 * Generar clave de acceso lote masivo tipo comprobante factura tipo ambiente
	 * prueba tipo emision normal.
	 *
	 * @param ruc             the ruc
	...
	public static String generarClaveDeAccesoLoteMasivoTipoComprobanteFacturaTipoAmbientePruebaTipoEmisionNormal(
			String ruc, Long establecimiento, BigInteger codigoNumerico) {
		return generarClaveDeAccesoLoteMasivo(Constantes.TIPO_COMPROBANTE_FACTURA, ruc,
				Constantes.TIPO_AMBIENTE_PRUEBAS, establecimiento, codigoNumerico, Constantes.TIPO_EMISION_NORMAL);
	}
	 ...
	 * @return the string
	 */
	public static String generarClaveDeAccesoLoteMasivo(String tipoComprobante, String ruc, String tipoAmbiente,
			Long establecimiento, BigInteger codigoNumerico, String tipoEmision) {
		...
		if (codigoNumerico.compareTo(LIMITE_CODIGO_NUMERICO_LOTE_MASIVO) >= 1) {
			throw new IllegalArgumentException(
					"El codigo numerico no debe ser mayor que " + LIMITE_CODIGO_NUMERICO_LOTE_MASIVO);
		}
	...
	/**
	 * Generar clave de acceso tipo comprobante factura tipo ambiente prueba tipo
	 * emision normal.
	 *
	 * @param ruc               the ruc
	 ...
	 * @return the string
	 */
	public static String generarClaveDeAccesoTipoComprobanteFacturaTipoAmbientePruebaTipoEmisionNormal(String ruc,
			Long serie, Long numeroComprobante, Long codigoNumerico, String fechaEmision) {
		return generarClaveDeAcceso(fechaEmision, Constantes.TIPO_COMPROBANTE_FACTURA, ruc,
				Constantes.TIPO_AMBIENTE_PRUEBAS, serie, numeroComprobante, codigoNumerico,
				Constantes.TIPO_EMISION_NORMAL);
	}
	 ...
	 * @return the string
	 */
	public static String generarClaveDeAcceso(String fechaEmision, String tipoComprobante, String ruc,
			String tipoAmbiente, Long serie, Long numeroComprobante, Long codigoNumerico, String tipoEmision) {
