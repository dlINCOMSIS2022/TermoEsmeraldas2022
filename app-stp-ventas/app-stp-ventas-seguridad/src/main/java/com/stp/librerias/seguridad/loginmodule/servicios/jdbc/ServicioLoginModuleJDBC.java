package com.stp.librerias.seguridad.loginmodule.servicios.jdbc;
...
import com.stp.librerias.generales.GestorQuerysJDBC;
import com.stp.librerias.generales.excepciones.ExcepcionLogin;
import com.stp.librerias.seguridad.loginmodule.servicios.IServiciosLoginModule;
...
//				" select f.USUARIO, f.clave " + " from cls_usuario f "
//				+ " where "
////				+ "f.estado = 'A' " + " and "
//						+ " upper(f.usuario) = upper(?)";
...
//		String query = "select f.clave from cls_usuario f where "
////				+ "f.estado = 'A' and "
//				+ " upper(f.usuario) = upper(?)";
		PreparedStatement sentencia = null;
		ResultSet resultado = null;
